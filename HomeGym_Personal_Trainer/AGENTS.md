# Home-Gym Personal Trainer - System & Agent Specifications (ADK 2.0)

This document defines the core architecture, state management, validation rules, and domain-specific constraints for the Home-Gym Personal Trainer web application using ADK 2.0.
